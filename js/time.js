function showTime() { 
	...
	var startDate = new Date(2017, 02, 22);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear Ms.Yang:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >--Mr.Wang    2019-03-07</c>"; 
